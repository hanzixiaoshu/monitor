...
def RunAll():
    ...
    iniconfig.read('/data/cluster_monitor/mongo_monitor/mongo_list.ini', encoding='utf-8')
    #读取所有sections项
    ...
    for sec_ip in sections_ip:
        ...
        for keys in iniconfig.options(sec_ip):
            ...
            #print(data_value)
            Push_Data(sec_ip, value_port, Connect_Port(sec_ip, int(value_port)), keys + "_Alive_" + value_port, keys)
